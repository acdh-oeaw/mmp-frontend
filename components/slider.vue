	...
	<div ref="ref" v-bind="api.rootProps">
		...
		<div v-bind="api.controlProps" class="relative flex items-center py-2.5">
			...
			<div
				...
				class="flex size-5 items-center justify-center rounded-full border border-neutral-400 bg-white shadow hover:border-neutral-500 focus:outline-1 focus:outline-blue-500 disabled:bg-neutral-200"
			>
